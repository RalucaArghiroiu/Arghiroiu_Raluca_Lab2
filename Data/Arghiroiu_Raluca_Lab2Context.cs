...
namespace Arghiroiu_Raluca_Lab2.Data
{
    public class Arghiroiu_Raluca_Lab2Context : DbContext
    {
        ...
        public DbSet<Arghiroiu_Raluca_Lab2.Models.Category>? Category { get; set; }

        public DbSet<Arghiroiu_Raluca_Lab2.Models.Member>? Member { get; set; }

        public DbSet<Arghiroiu_Raluca_Lab2.Models.Borrowing>? Borrowing { get; set; }
    }
}
