...
namespace Arghiroiu_Raluca_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Arghiroiu_Raluca_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Arghiroiu_Raluca_Lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {
                ...
                else
                {
                    if (bookCategories.Contains(cat.ID))
                    {
                        BookCategory categoryToRemove = bookToUpdate.BookCategories
                            .SingleOrDefault(bc => bc.CategoryID == cat.ID);
